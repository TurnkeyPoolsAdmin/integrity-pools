...
const features = [
  {
    ...
    title: "Pool Expertise Leads Every Project",
  },
  {
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
    ...
    title: "Landscaping Can Be Aligned Before Construction",
  },
  {
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
    ...
    title: "Your Family's Safety Stays a Priority",
  },
  {
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
    ...
    title: "Clear Scope, Costs, and Responsibilities",
  },
  {
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
    ...
    title: "Licensed, Insured, and PHTA Certified",
  },
  {
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
    ...
    title: "Personal Updates From Design to Final Walkthrough",
  },
];
